...
for mfile0 in glob.glob("*sepsign*2HM_ssmd_stimuli_stand*tbl*csv"):
...
#print(c.flatten()) # this is the matrix colors
	...
	#fig.colorbar(col)
	if "base" in prefix:
		#fig.set_size_inches(6,4) 6,3 is standard for a hetinx, 6,4 is good for hethomxhomhet, 6,8 is for the larger like hdlbp and 6,7 for tbl from asd set
		fig.set_size_inches(6,4)
	elif "stim" in prefix:
		fig.set_size_inches(12,7) #12,3 is standard for hetinx, 12,4
	plt.tight_layout()
	#plt.subplots_adjust(bottom=0.4)
	#plt.show()
	plt.savefig("heatmapnolabel_" + prefix + ".pdf",dpi=300)
	plt.close()
